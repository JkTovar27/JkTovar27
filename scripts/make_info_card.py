...
# ===========================================================================
HOST = "JkTovar27"   # shown as  you@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Systems & Computer Engineering Student"),
    ("kv", "Prev", "Developer @ CONOC3R"),
    ("kv", "Also", "Promoter of AI in Public Education"),
    ("kv", "Edu", "EIA University"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "AI / ML", "PyTorch, TensorFlow, LLMs, RAG, LangChain"),
    ("kv", "LLMOps", "MLflow, DVC, Prompt Eng, Fine-tuning"),
    ("kv", "Comp Prog", "C++, Python, DSA, Algorithms, CP"),
    ("kv", "Quantum", "Qiskit, Cirq, Pennylane, VQE, QAOA"),
    ("kv", "HPC", "C/C++, CUDA, OpenMP, MPI, SIMD"),
    ("kv", "Systems", "Linux, Docker, Git, CI/CD, Bash"),
    ("kv", "Data", "PostgreSQL, Redis, Pandas, NumPy, Polars"),
    ("gap",),
    ("sec", "Projects"),
    ("bul", "CONOC3R — AI Education Platform (Founder)"),
    ("bul", "Quantum ML Research — VQE for NISQ devices"),
    ("bul", "Competitive Programming — ICPC Regionalist"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Founder at CONOC3R"),
    ("bul", "Leadership and Personal Growth"),
    ("bul", "AI First Mindset Advocate"),
