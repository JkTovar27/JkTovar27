...
CURSOR = "#c9d1d9"
PROFILE_USER = "JkTovar27"
DISPLAY_NAME = "Juan Camilo Tovar"
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">{PROFILE_USER}@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'{PROFILE_USER}@github:~$ whoami <tspan fill="{INK}">{DISPLAY_NAME}</tspan></text>')
